...
public class CustomEditDialog {
    ...
    private void init(Activity activity, boolean cancelOutOutside) {
        if (this.confirmDialog == null) {
            ...
            this.confirmDialog.setContentView(R.layout.dialog_custom_edit);
            ...
            public void onClick(View v) {
                if (listener != null) {
                    ...
                    if (!"".equals(messageTextStr)) {
                        listener.onSure(CustomEditDialog.this, messageTextStr);
                        hide();
                    } else {
    ...
    public static abstract class OnClickListener {
        ...
        public abstract void onSure(CustomEditDialog dialog, String editText);
